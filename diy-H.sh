...
cd $CURRENT_DIR/$DIR
#共存
sed -i 's/com.github.tvbox.osc/com.github.tvbox.osc.hbpy/g' $CURRENT_DIR/$DIR/app/build.gradle
#签名
...
#名称修改
sed -i 's/TVBox/Me₸v-HP/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml
