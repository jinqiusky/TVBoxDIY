...
//             public void run() {
//                 try {
//                     String url1 = "https://gitee.com/zhoujck/tv/raw/master/EXT/yiyan.json";
...
// };
  private void sendRequestWithHttpClient() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    String url1 = "https://gitee.com/zhoujck/tv/raw/master/EXT/tvtalk.json";
                    URL url = new URL(url1);
                    //得到connection对象。
                    HttpURLConnection connection = (HttpURLConnection) url.openConnection();
                    //设置请求方式
                    ...
                    if (responseCode == HttpURLConnection.HTTP_OK) {
                        ...
                        //String value = jsonObject.optString("content");
                        tvword.setText(result);                     
                    } 
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    private void initView() {
        tvword = findViewById(R.id.tvtalk);
        this.tvword = findViewById(R.id.tvtalk);
