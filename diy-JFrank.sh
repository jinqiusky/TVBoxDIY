...
#添加js支持
#1.JS源本地包API引用内置方法: "api" : "assets://js/lib/drpy.ym.js"
#2.兼容q版tvbox本地js源文件: "api" : "assets://js/lib/drpy.js"
mv $CURRENT_DIR/DIY/drpy.js $CURRENT_DIR/$DIR/assets/js/lib/drpy.js
mv $CURRENT_DIR/DIY/drpy.min.js $CURRENT_DIR/$DIR/assets/js/lib/drpy.min.js
mv $CURRENT_DIR/DIY/drpy.ym.js $CURRENT_DIR/$DIR/assets/js/lib/drpy.ym.js
